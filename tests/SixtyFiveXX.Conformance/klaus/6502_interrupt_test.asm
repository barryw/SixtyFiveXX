...
zpt
irq_a   .fill  1               ;a register
irq_x   .fill  1               ;x register
irq_f   .fill  1               ;flags
nmi_a   .fill  1               ;a register
nmi_x   .fill  1               ;x register
nmi_f   .fill  1               ;flags
zp_bss
...
nmi_count   .fill  1           ;lowest number handled first, $ff = never
irq_count   .fill  1           ;separation-1 = instructions between interrupts
brk_count   .fill  1
;expected interrupt mask
I_src       .fill  1           ;bit: 0=BRK, 1=IRQ, 2=NMI
data_bss
...
; IRQ & NMI test - requires a feedback register
    .if I_drive > 1
        .error "invalid interrupt drive!"           ;invalid interrupt drive!
    .endif
  .if NMI_bit < 0
