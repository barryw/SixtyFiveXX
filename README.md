...
**This is not a complete core.** 187 of the 65816's 256 opcodes are implemented — phase 7b's 32,
...
first opcodes with no operand at all.
...
in progress — its remaining tasks add the transfers and `XBA` — and phase 7d adds control flow,
the stack and interrupts after it.
